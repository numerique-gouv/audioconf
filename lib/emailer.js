...
module.exports.sendConfCreatedEmail = async function (
  ...
  let expirationInfo = ""
  if (conferenceDay) {
    expirationInfo = `Ce numéro de conférence sera actif ça actif jusqu'au ${format.formatFrenchDate(new Date(conferenceDay))} et expirera à minuit heure locale (${format.GMTString(userTimezoneOffset)}).`
  } else {
  ...
  <div class="paragraph">
    <div>
      Votre conférence numéro de téléphonique
