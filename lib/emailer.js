...
module.exports.sendConfCreatedEmail = async function(toEmail, phoneNumber, pin, durationInMinutes, freeAt) {
  const html = `
  <p>Bonjour,</p>
  <p></p>
  ...
  <ul>
    <li>appelez le <strong>${format.formatFrenchPhoneNumber(phoneNumber)}</strong> sur votre téléphone pro ou perso</li>
    <li>tapez le code d'accès à ${config.NUM_PIN_DIGITS} chiffres : <strong>${pin}</strong></li>
  </ul>
  <p></p>
  <p>Ce numéro de conférence est actif pendant ${format.formatMinutesInHours(durationInMinutes)}. Il expirera ${format.formatFrenchDate(freeAt)}.</p>
