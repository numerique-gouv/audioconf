...
module.exports.sendConfCreatedEmail = async function(toEmail, confPhoneNumber, pin) {
  ...
  <p></p>
  <p>Ce numéro de conférence est actif pendant ${config.CONFERENCE_DURATION_IN_MINUTES/60} heure${ config.CONFERENCE_DURATION_IN_MINUTES > 120 ? 's' : ''}. Il peut accueillir jusqu'à 50 personnes.</p>
  <p></p>
