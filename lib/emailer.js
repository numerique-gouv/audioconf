...
module.exports.sendConfCreatedEmail = async function(toEmail, phoneNumber, pin, durationInMinutes, conferenceDay, freeAt, confUrl, pollUrl, userTimezoneOffset = -60) {
  let pollHtml = ''
  if (pollUrl) {
    pollHtml = `<hr />
    <div class="paragraph">
