...
module.exports.sendConfCreatedEmail = async function(toEmail, phoneNumber, pin, durationInMinutes, freeAt, confUrl) {
  ...
  <div class="paragraph">
    ...
    <ul>
      <li>appelez le <a href="tel:${format.formatFrenchPhoneNumber(phoneNumber),,${config.NUM_PIN_DIGITS}"><strong>${format.formatFrenchPhoneNumber(phoneNumber)}</strong></a> sur votre téléphone pro ou perso</li>
