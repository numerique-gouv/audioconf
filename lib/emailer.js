...
module.exports.sendConfCreatedEmail = async function(toEmail, formattedPhoneNumber, pin, durationInMinutes, formattedFreeAt) {
  const html = `
  <p>Bonjour,</p>
  <p></p>
  ...
  <p></p>
  <p>Ce numéro de conférence est actif pendant ${format.formatMinutesInHours(durationInMinutes)}. Il expirera ${formattedFreeAt}.</p>
