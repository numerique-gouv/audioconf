...
module.exports.sendSurveyEmail = async function (toEmail) {
  ...
  <p>Bonjour,</p>
  <p></p>
  <p>Vous avez récemment utilisé le service de conférence <a href="https://audioconf.numerique.gouv.fr/contact"><b>AudioConf</b></a>.</p>

  <p>Aidez-nous à améliorer notre produit en répondant à ce court questionnaire.</p>

  <a class="rf-btn rf-btn rf-btn"
    title="Donnez votre avis"
    target="_blank"
    rel="noopener"
    href="${config.POLL_URL}">
      Donnez votre avis
  </a>
  ...
  try {
    return await sendMail(config.MAIL_SENDER_EMAIL, toEmail, "Donner votre avis sur audioconf.numerique.gouv.fr", html)
  } catch (err) {
