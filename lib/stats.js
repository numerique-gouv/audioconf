 ...
 * [{"date":"2020-11-05T14:11:00.440Z","onlineParticipantsCount":0,"activeConfsCount":0,"errorConfsCount":0,"freePhoneNumbersCount":9},
 * {...}, ...]
 * outData is formatted like :
 * { labels: [dates], onlineParticipantsSeries: [series], activeConfsSeries: [series], freePhoneNumbersSeries: [series] }
 */
module.exports.formatDataForDisplay = (inData) => {
  const outData = { labels: [], onlineParticipantsSeries: [], activeConfsSeries: [], freePhoneNumbersSeries: [] }
