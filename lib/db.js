...
module.exports.getLatestStatsPoint = async () => {
    try {
        ...
        return statsPointArray[0]
    } catch (err) {
      console.error(`Impossible de récupérer le statsPoint`, err)
      throw new Error('Impossible de récupérer le statsPoint')
    }
}
