...
module.exports.getUnexpiredConference = async (id) => {
    try {
      ...
      console.error(`getUnexpiredConference: Impossible de récupérer la conférence ${id}`, err)
...
module.exports.cancelConference = async (id) => {
    try {
        ...
        if(!conference) {
            console.error(`cancelConference: Impossible de récupérer la conférence ${id}`)
